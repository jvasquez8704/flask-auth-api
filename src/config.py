...
class DEV:
  ...
  #[Credentials]
  GOOGLE_APPLICATION_CREDENTIALS = './src/db_keys/watch-party-site-dev.json'
  CREDENTIALS_FIREBASE_SDK_PATH = './src/db_keys/watch-party-site-dev.json'
...
class PRD:
  ...
  #[Credentials]
  GOOGLE_APPLICATION_CREDENTIALS = './src/db_keys/watch-party-site-prod.json'
  CREDENTIALS_FIREBASE_SDK_PATH = './src/db_keys/watch-party-site-prod.json'
